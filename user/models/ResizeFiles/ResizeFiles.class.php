...
class TutsupRedimensionaImagem {
    ...
    public $extensoes = array('jpg', 'jpeg', 'png', 'gif');
    ...
    public function executa() {
        ...
        if ('jpg' === $extensao) {
            ...
            imagecopyresampled(
                    $imagem_redimensionada, $this->r_imagem, 0, 0, 0, 0, $this->nova_largura, $this->nova_altura, $this->largura_original, $this->altura_original
            );
            ...
            imagejpeg(
                    $imagem_redimensionada, $this->imagem_destino, $this->qualidade
            );
        }
        ...
        /* Se a extensão for png */ elseif ('png' === $extensao) {
            ...
            $this->nova_imagem = imagecreatetruecolor($this->nova_largura, $this->nova_altura);
            imagealphablending($this->nova_imagem, true);
            imagesavealpha($this->nova_imagem, true);
            $this->cor_fundo = imagecolorallocatealpha($this->nova_imagem, 0, 0, 0, 127);
            imagefill($this->nova_imagem, 0, 0, $this->cor_fundo);
            ...
            /* Cria a imagem ou exibe na tela */
            imagepng($this->nova_imagem, $this->imagem_destino, $this->qualidade);


        } /* png */

        /* Se a extensão for gif */ elseif ('gif' === $extensao) {
...
/* executa() */
    ...
    final private function redimensiona() {
        ...
        $this->nova_largura = $this->largura ? $this->largura :
                floor(( $this->largura_original / $this->altura_original ) *
                        $this->altura);

        /* Configura a nova altura */
        $this->nova_altura = $this->altura ? $this->altura :
